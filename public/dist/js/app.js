...
/* harmony import */ var urljs_src_url_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! urljs/src/url.min.js */ "./node_modules/urljs/src/url.min.js");
/* harmony import */ var urljs_src_url_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(urljs_src_url_min_js__WEBPACK_IMPORTED_MODULE_1__);



(function (D, B, W) {
  var log = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : function (arg) {
    return console.log(arg);
  };
  var $q = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : function (arg) {
    return D.querySelector(arg);
  };
  var $qAll = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : function (arg) {
    return D.querySelectorAll(arg);
  };
  $qAll('[data-sort]').forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      var el = e.target;
      urljs_src_url_min_js__WEBPACK_IMPORTED_MODULE_1___default.a.updateSearchParam('sort', el.dataset.sort);
      urljs_src_url_min_js__WEBPACK_IMPORTED_MODULE_1___default.a.updateSearchParam('order', el.dataset.order);
      window.location.reload();
    });
  });
  $qAll('[data-pagination]').forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      urljs_src_url_min_js__WEBPACK_IMPORTED_MODULE_1___default.a.updateSearchParam('page', e.target.dataset.pagination);
      window.location.reload();
    });
  });
...
/***/ 0:
/*!***************************************************************************************************************!*\
  !*** multi ./public/src/js/app.js ./node_modules/bootstrap/scss/bootstrap.scss ./public/src/scss/custom.scss ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /usr/share/nginx/html/public/src/js/app.js */"./public/src/js/app.js");
__webpack_require__(/*! /usr/share/nginx/html/node_modules/bootstrap/scss/bootstrap.scss */"./node_modules/bootstrap/scss/bootstrap.scss");
module.exports = __webpack_require__(/*! /usr/share/nginx/html/public/src/scss/custom.scss */"./public/src/scss/custom.scss");
